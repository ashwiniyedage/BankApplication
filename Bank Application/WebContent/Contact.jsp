...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-dark" style="background-color: #292075;">
		<div class="container">
			...
			<div class="collapse navbar-collapse text-center" id="collapsenavbar">
				<ul class="navbar-nav ml-auto" >
					...
					<li class="nav-item">
						<a href="createUser.jsp" class="nav-link text-white">Create User</a>
					</li>
					<li class="nav-item">
						<a href="transferMoney.jsp" class="nav-link text-white">Money Transfer</a>
					</li>
					<li class="nav-item">
						<a href="history.jsp" class="nav-link text-white">Transaction History</a>
					</li>
					<li class="nav-item">
	...
	<div class= "container text-right text-white imgset">
		<h1 style="font-weight:bold;">We would love to hear from you</h1>
		<h5 style="font-weight:bold;">Contact us through any mode for your queries.</h5>
	</div>
	</div>
	...
	<h4><strong>ATM Service</strong></h4>
	<h6><strong>Global Bank Contact Details for ATM card and Credit Card</strong></h6>
	<p>For Hotlisting and ATM cash withdrawal failure complaints </p>
	<p><strong>Toll Free :</strong> 1800 233 4526  or 1800 102 2636</p>
	<p><strong>Land Line :</strong> 020-26104400 / 020-48527200 (Mahaseva) </p>
	<p><strong>Other lines :</strong> 020-27008666 (DC) for hotlisting only</p>
	<h6><strong>ATM Card Cell, Pune : </strong></h6>
	<p>Janmangal, Bajirao Road, Guruvar Peth, Pune, 41002<br>
	(Card number or a/c number to be furnished)<br>
	020-24506201<br>
	020-24506217</p>
	<p><strong>Email : </strong>For issues related to ATM Card Services : <a href="#">atmclaim@mahabank.co.in</a></p>
	<p><strong>General Toll free number (MAHASEVA - 24x7) :</strong><br>
	<p><strong>Credit Card related issues - BOM-SBI Credit card</strong></p>
	<p><strong>Email :  </strong><a href="#">creditcardcell@mahabank.co.in</a><br>
	SBI CREDIT CARD complaints Toll free number 18601801290
	1800-233-4526 </p>
	<p><strong>To lodge any complaint through email :</strong><br>
	<a href="#">hocomplaints@mahabank.co.in</a><br>
	<a href="#">cmcustomerservice@mahabank.co.in</a></p>
	
	<div class="responsive-map-container">
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15136.798409694511!2d73.81136472847514!3d18.47461579897092!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc295590e4b91e3%3A0xd3bf2a068a926e!2sAnand%20Nagar%2C%20Pune%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1585747576775!5m2!1sen!2sin"
				width="900" height="450" frameborder="0" style="border: 0;"
				allowfullscreen="" aria-hidden="false" tabindex="0" style="border:0"></iframe>
		</div>
	</div>
	
	<div class="text-center ">
	<h2 style="font-weight:bold;padding-top:50px;">Connect With Us</h2>	
	<nav class="navbar navbar-expand-md bg-light navbar-light">
	...
	<div class="container text-center text-md-left">
		...
		<div class="footer-copyright text-center py-3">
			© 2020 Copyright: <a href="https://mdbootstrap.com/">
				GlobalBank</a>Made By Ashwini Yedge
		</div>
		<!-- Copyright -->
	</footer>
</body>
